...
/// Date: 2023-05-01 21:04:58
/// LastEditTime: 2023-05-02 05:58:44
/// FilePath: /lib/libs/sr/services/tools/warp/main.dart
/// ===========================================================================

import 'package:srcat/utils/file/mh.dart';
...
class SrWrapToolService {
  /// 从缓存获取跃迁链接
  static Future<Uri?> gachaLink() async {
    String? uri = await MHoYFileUtils.getWarpUrl();
  ...
  /// 获取用户 SToken
  static Future<String?> stoken() async {
    return null;
  }
  ...
  static Future<void> getGachaData({
    ...
    String apiUrl = "https://api-takumi.mihoyo.com/common/gacha_record/api/getGachaLog?"
      ...
      "page=%page%"                             "&"
      "size=%size%"                             "&"
      "gacha_type=%gacha_type%"                 "&" // 11: 角色 | 12: 武器 | 1: 常驻 | 10: 新手
      "end_id=%end_id%"                         "";
